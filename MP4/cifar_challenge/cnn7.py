...
class BaseNet(nn.Module):
    def __init__(self):
        ...
        self.conv7 = conv_relu(256, 512, 3,  padding=1)
        self.conv8 = conv_relu(512, 512, 3,  padding=1)
        self.conv9 = conv_relu(512, 1024, 3,  padding=1)
        self.conv10 = conv_relu(1024, 1024, 3,  padding=1)
        self.pool = nn.MaxPool2d(2, 2)
...
for epoch in range(EPOCHS):  # loop over the dataset multiple times
    ...
    print('7 Accuracy of the network on the val images: %d %%' % (val_accuracy))
...
with open('huaminz2_7.csv', 'w') as csvfile:
