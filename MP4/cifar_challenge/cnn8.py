...
class BaseNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = conv_relu(3, 64, 3,  padding=0)
        self.conv2 = conv_relu(64, 64, 3,  padding=0)
        self.conv3 = conv_relu(64, 128, 3,  padding=0)
        self.conv4 = conv_relu(128, 128, 3,  padding=0)
...
for epoch in range(EPOCHS):  # loop over the dataset multiple times
    ...
    print('8 Accuracy of the network on the val images: %d %%' % (val_accuracy))
...
with open('huaminz2_8.csv', 'w') as csvfile:
