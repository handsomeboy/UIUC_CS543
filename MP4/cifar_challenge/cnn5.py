...
class BaseNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = conv_relu(3, 64, 3,  padding=1)
        self.conv2 = conv_relu(64, 64, 3,  padding=1)
        self.conv3 = conv_relu(64, 128, 3,  padding=1)
        self.conv4 = conv_relu(128, 128, 3,  padding=1)
        self.conv5 = conv_relu(128, 256, 3,  padding=1)
        self.conv6 = conv_relu(256, 256, 3,  padding=1)
        self.conv7 = conv_relu(256, 256, 3,  padding=1)
        self.conv8 = conv_relu(256, 512, 3,  padding=1)
        self.conv9 = conv_relu(512, 512, 3,  padding=1)
        self.conv10 = conv_relu(512, 512, 3,  padding=1)
        self.conv11 = conv_relu(512, 512, 3,  padding=1)
        self.conv12 = conv_relu(512, 512, 3,  padding=1)
        self.conv13 = conv_relu(512, 512, 3,  padding=1)
...
for epoch in range(EPOCHS):  # loop over the dataset multiple times
    ...
    print('5 Accuracy of the network on the val images: %d %%' % (val_accuracy))
...
with open('huaminz2_5.csv', 'w') as csvfile:
